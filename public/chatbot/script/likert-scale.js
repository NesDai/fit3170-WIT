 ...
 */
 ...
 hash[EN_INDEX] =
     [
         ...
         // Often
         ["Never","Once a<br> month","Few times<br> a month","Once a<br> week","Few times<br> a week","Once a<br> day","Many times<br> a day"]
     ];
 ...
 hash[ZH_CN_INDEX] =
     [
         ...
         // Often
         ["绝不","每月一次","一个月几次","每周一次","一周几次","一天一次","一天很多次"]
     ];
 ...
 hash[TH_INDEX] =
     [
         ...
         // Often
         ["ไม่เคย","เดือนละครั้ง","เดือนละไม่กี่ครั้","สัปดาห์ละครั้ง","ไม่กี่ครั้งต่อสัปดาห์","วันละครั้ง","วันละหลายครั้ง"]
     ];
...
function makeLikertScale(language, type) {
    ...
    switch (type){
        ...
        case "interested":
            ...
            break;
        case "often":
            scaleString = getScaleString(language, 4, [1, 2, 3, 4, 5,6,7]);
        default:
